  ...
  return (
    <footer className="bg-carrot-orange text-pure-white px-[5%] py-10 font-inter">
      ...
      <div className="flex flex-col items-start mb-10">
        ...
        <p className="text-[18px] lg:text-[20px] font-[400] text-pure-white">
      ...
      {/* Quick Links */}
      <div className="mb-10">
        <h3 className="font-fredoka font-[400] text-[24px] text-pure-white mb-2">Quick Links</h3>
        <ul className="flex flex-col gap-2 font-inter text-[18px] lg:text-[20px] font-[400] text-pure-white">
      ...
      {/* Contact Info */}
      <div className="mb-4">
        <h3 className="font-fredoka font-[400] text-[24px] text-pure-white mb-2">Contact Info</h3>
        <ul className="flex flex-col gap-2 font-inter text-[18px] lg:text-[20px] font-[400] text-pure-white">
      ...
      {/* Divider */}
      <hr className="border-white/30 mt-8 mb-6" />

      {/* Bottom Copyright Section */}
      <div className="font-inter text-[18px] lg:text-[20px] font-[400] text-pure-white">
        <p>© 2025 Alosa Arts. All rights reserved.</p>
        <p>
          Designed by{" "}
